...
def display():
    ...
    background_img = PhotoImage(file = f"Delivery-Management-System/assets/images/slbackground.png")
    background = canvas.create_image(649.0, 400.0,image=background_img)

    img0 = PhotoImage(file = f"Delivery-Management-System/assets/images/slsignupbox.png")
    ...
    img1 = PhotoImage(file = f"Delivery-Management-System/assets/images/slloginbox.png")
