...
def endwin(fname):
    ...
    background_img = PhotoImage(file = f"Delivery-Management-System/assets/images/endbackground.png")
    background = canvas.create_image(649.0, 400.0,image=background_img)

    img0 = PhotoImage(file = f"Delivery-Management-System/assets/images/endimg0.png")
    ...
    img1 = PhotoImage(file = f"Delivery-Management-System/assets/images/invoice_button.png")
