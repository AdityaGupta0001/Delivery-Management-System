...
##                    for i in data:
##                        invoice.add_item(Item(data[i], menuprices.menu[i], description=i, tax=5))
    ...
    #Defining and centering tkinter window
    root = Tk()
    ...
    background_img = PhotoImage(file = f"billbackground.png")
    background = canvas.create_image(649.0, 400.0,image=background_img)

    entry0_img = PhotoImage(file = f"billimg_textBox0.png")
    ...
    entry1_img = PhotoImage(file = f"billimg_textBox1.png")
    ...
    entry2_img = PhotoImage(file = f"billimg_textBox2.png")
    ...
    entry3_img = PhotoImage(file = f"billimg_textBox3.png")
    ...
    entry4_img = PhotoImage(file = f"billimg_textBox4.png")
    ...
    img3 = PhotoImage(file = f"billimg3.png")
    ...
    img4 = PhotoImage(file = f"billimg4.png")
